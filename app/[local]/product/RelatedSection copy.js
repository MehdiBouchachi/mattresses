    ...
    return (
      <section className="py-16 sm:py-20 lg:py-24 border-t border-blue-100 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-semibold text-blue-900 mb-10">
            {title}
          </h2>
              ...
              return (
                ...
                >
                  ...
                  <div className="p-5">
                    ...
                    <h3 className="text-sm sm:text-base font-semibold text-blue-900 mb-3 line-clamp-2">
                      {item.name}
                    </h3>
                    ...
                    <Link href={`/${locale}/product/${item.slug}`}>
                      <button className="w-full border border-blue-600 text-blue-600 py-2 rounded-full text-sm hover:bg-blue-600 hover:text-white transition">
