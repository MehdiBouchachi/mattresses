...
function ContactHero({ hero }) {
  return (
    <section className="relative pt-28 sm:pt-36 lg:pt-44 pb-20 text-center overflow-hidden">
      {/* Soft Blue Glow */}
      <div className="absolute -top-40 left-1/2 -translate-x-1/2 w-[700px] h-[700px] bg-blue-100 rounded-full blur-[180px] opacity-40" />

      <div className="relative max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="text-3xl sm:text-4xl lg:text-5xl font-semibold tracking-tight mb-6 text-blue-900">
          {hero.title}
        </h1>
...
function ContactItem({ icon, title, text }) {
  return (
    <div className="flex items-start gap-5">
      ...
      <div>
        <h3 className="font-semibold mb-1 text-base text-blue-900">{title}</h3>
