...
export default function WhyLitmadSection() {
  return (
    <section className="py-44 bg-[#F3EEE6]">
      <div className="max-w-7xl mx-auto px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-24 items-center mb-28">
          ...
          <div className="space-y-8">
            <div className="border-l-4 border-[#2B2D6E] pl-6">
        ...
        {/* ===== TRUST STRIP ===== */}
        <div className="grid grid-cols-3 text-center border-t border-[#E0DBD3] pt-10">
          <div>
            <p className="text-3xl font-semibold">10+</p>
            <p className="text-sm text-[#6A6A6A] mt-2">Years of Expertise</p>
          </div>

          <div>
            <p className="text-3xl font-semibold">98%</p>
            <p className="text-sm text-[#6A6A6A] mt-2">Customer Satisfaction</p>
          </div>

          <div>
            <p className="text-3xl font-semibold">100%</p>
            <p className="text-sm text-[#6A6A6A] mt-2">Premium Materials</p>
          </div>
        </div>
      </div>
    </section>
